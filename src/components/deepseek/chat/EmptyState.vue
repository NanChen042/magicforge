<template>
  <div class="flex flex-col items-center justify-center min-h-full p-8 text-center max-w-3xl mx-auto animate-in fade-in duration-500">
    ...
    <div class="mb-12 flex flex-col items-center relative">
      ...
      <div class="w-16 h-16 rounded-md bg-linear-to-br from-zinc-900 to-zinc-700 flex items-center justify-center mb-6 shadow-xl shadow-zinc-900/10 ring-1 ring-black/5 rotate-3 hover:rotate-0 transition-transform duration-500">
    ...
    <div class="w-full">
      ...
      <div v-if="isLoadingTopics" class="flex items-center justify-center min-h-[180px] bg-zinc-50/50 rounded-md border border-zinc-100 border-dashed">
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        <button
          ...
          class="group relative w-full p-3.5 text-left bg-white border border-zinc-200 rounded-sm hover:border-zinc-400 hover:shadow-lg hover:shadow-zinc-900/5 transition-all duration-300 active:scale-[0.98]"
        >
