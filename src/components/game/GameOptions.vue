...
<template>
  <div class="space-y-4" :class="{ 'opacity-60 pointer-events-none grayscale': isGenerating }">
    ...
    >
      <!-- 选项卡片 -->
      <div class="relative bg-white rounded-sm p-5 border border-slate-200 transition-all duration-300 group-hover:-translate-y-1 group-hover:border-amber-300 group-hover:shadow-md overflow-hidden">
    ...
    <div v-if="!isGenerating && currentScene?.id === 999" class="text-center py-10 animate-fade-in-up">
      <div class="relative overflow-hidden bg-white border border-slate-200 rounded-md p-8 shadow-xl">
        <!-- 背景装饰 -->
        ...
        <div class="relative z-10">
           ...
           <button
             ...
             class="px-8 py-3 rounded-sm font-bold text-sm uppercase tracking-wider bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white shadow-lg shadow-amber-200 hover:shadow-amber-300 transition-all transform hover:-translate-y-1"
           >
             再启征程
           </button>
        </div>
    ...
    >
      <div class="bg-red-50 border border-red-100 rounded-sm p-6 shadow-sm">
        ...
        <button
          ...
          class="px-6 py-2 bg-white border border-red-200 text-red-600 rounded-sm hover:bg-red-50 transition-colors text-sm flex items-center justify-center gap-2 mx-auto font-medium shadow-sm"
        >
