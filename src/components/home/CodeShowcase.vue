<template>
  ...
  <section class="max-w-5xl mx-auto mb-8 relative z-20">
    ...
    <div class="bg-slate-900 rounded-md shadow-2xl shadow-slate-900/50 overflow-hidden ring-1 ring-white/10">
...
// 文档 OCR 转 Markdown
const markdown = await client.ocr({
  model: 'deepseek-ocr',
  image: documentImage
});
